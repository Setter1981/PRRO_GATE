...
internal class Directorys
{
	...
	public string PayISCASH
	{
		get
		{
			...
			if ((index > 0) & (index < checked(PayS + 1)))
			{
				string text = Pay[1, index];
				if (Operators.CompareString(text, "1", false) == 0)
				{
					return "0";
				}
				if (Operators.CompareString(text, "102", false) == 0)
				{
					return "2";
				}
				return "1";
	...
	public int PayABCtoNum
	{
		get
		{
			...
			{
				string text = Strings.Replace(Pay[0, i].Trim().ToLower(), "&#39;", "'", 1, -1, (CompareMethod)0);
			...
			else
			{
				...
				else
				{
					try
					{
						...
						tax = (string[,])Utils.CopyArray((Array)tax, (Array)new string[6, num + 1]);
						Tax[0, num] = "А";
						Tax[1, num] = "0";
						Tax[2, num] = "20";
						...
						tax2 = (string[,])Utils.CopyArray((Array)tax2, (Array)new string[6, num + 1]);
						Tax[0, num] = "Б";
						Tax[1, num] = "0";
						Tax[2, num] = "0";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax3 = (string[,])Utils.CopyArray((Array)tax3, (Array)new string[6, num + 1]);
						Tax[0, num] = "В";
						Tax[1, num] = "0";
						Tax[2, num] = "7";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax4 = (string[,])Utils.CopyArray((Array)tax4, (Array)new string[6, num + 1]);
						Tax[0, num] = "ГА";
						Tax[1, num] = "5";
						Tax[2, num] = "20";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax5 = (string[,])Utils.CopyArray((Array)tax5, (Array)new string[6, num + 1]);
						Tax[0, num] = "ГБ";
						Tax[1, num] = "5";
						Tax[2, num] = "0";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax6 = (string[,])Utils.CopyArray((Array)tax6, (Array)new string[6, num + 1]);
						Tax[0, num] = "ДА";
						Tax[1, num] = "7.5";
						Tax[2, num] = "20";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax7 = (string[,])Utils.CopyArray((Array)tax7, (Array)new string[6, num + 1]);
						Tax[0, num] = "ДБ";
						Tax[1, num] = "7.5";
						Tax[2, num] = "0";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax8 = (string[,])Utils.CopyArray((Array)tax8, (Array)new string[6, num + 1]);
						Tax[0, num] = "Е";
						Tax[1, num] = "0";
						Tax[2, num] = "0";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax9 = (string[,])Utils.CopyArray((Array)tax9, (Array)new string[6, num + 1]);
						Tax[0, num] = "Ж";
						Tax[1, num] = "0";
						Tax[2, num] = "0";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax10 = (string[,])Utils.CopyArray((Array)tax10, (Array)new string[6, num + 1]);
						Tax[0, num] = "З";
						Tax[1, num] = "0";
						Tax[2, num] = "0";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
						...
						tax11 = (string[,])Utils.CopyArray((Array)tax11, (Array)new string[6, num + 1]);
						Tax[0, num] = "К";
						Tax[1, num] = "0";
						Tax[2, num] = "14";
						Tax[5, num] = ABCtoNUM(Tax[0, num]);
		...
		checked
		{
			try
			{
				...
				while (sQLiteDataReader.Read())
				{
					...
					pay = (string[,])Utils.CopyArray((Array)pay, (Array)new string[3, num + 1]);
	...
	internal int AddPayTemp(string NamePay, string GroupPay = "0")
	{
		...
		checked
		{
			try
			{
				PayS++;
				ref string[,] pay = ref Pay;
				pay = (string[,])Utils.CopyArray((Array)pay, (Array)new string[3, PayS + 1]);
				Pay[0, PayS] = NamePay;
				Pay[1, PayS] = GroupPay;
				Pay[2, PayS] = "0";
			}
	...
	public TypErrTaxABC Search(string NameTaxe)
	{
		...
		{
			if (Operators.CompareString(Tax[0, num].Trim().ToLower(), NameTaxe.Trim().ToLower(), false) == 0)
			{
	...
	public TypErrTaxABC SearchTaxPr(string PrTaxe)
	{
		...
		for (num = 1; num <= taxS; num = checked(num + 1))
		{
			if (Operators.CompareString(Tax[2, num].Trim().ToLower(), PrTaxe.Trim().ToLower(), false) == 0)
			{
	...
	{
		if (Operators.CompareString(NamePay.ToLower().Trim(), "готівка", false) == 0)
		{
			return "ГОТІВКА";
		}
		return "БЕЗГОТІВКОВА";
	...
	public int NamePayToIndex(string eNamePay, bool Synonyms = true)
	{
		...
		if (Synonyms)
		{
			if (Operators.CompareString(eNamePay, "", false) == 0)
			{
				return 999999999;
			}
		...
		{
			if (Operators.CompareString(Pay[0, i].ToLower(), eNamePay, false) == 0)
			{
				return i;
			}
		}
