...
public class ForServer
{
	...
	public bool RequestOfflineNumbers(string eMin, string eMax)
	{
		...
		int num2 = ((!Versioned.IsNumeric((object)eMax)) ? 500 : Conversions.ToInteger(eMax));
		int num3 = ((!Versioned.IsNumeric((object)eMin)) ? 50 : Conversions.ToInteger(eMin));
		if (num2 > 2000)
		{
			num2 = 2000;
		}
	...
	public string GetCheckByFiscalNumberEX(string TAXn, string FNs)
	{
		...
		return Strings.Replace(typErrStr.ReturnStr, "mmmaaaccc", text, 1, -1, (CompareMethod)0);
	}
