...
internal sealed class MyProject
{
	...
	internal sealed class MyForms
	{
		...
		public Form0 Form0
		{
			get
			{
				m_Form0 = Create__Instance__(m_Form0);
				return m_Form0;
			}
			set
			{
				if (value != m_Form0)
				{
					...
					Dispose__Instance__(ref m_Form0);
				}
			}
		}
	...
	private static readonly ThreadSafeObjectProvider<WebCheck.My.MyComputer> m_ComputerObjectProvider = new ThreadSafeObjectProvider<WebCheck.My.MyComputer>();

	private static readonly ThreadSafeObjectProvider<WebCheck.My.MyApplication> m_AppObjectProvider = new ThreadSafeObjectProvider<WebCheck.My.MyApplication>();
	...
	internal static WebCheck.My.MyComputer Computer
	{
		[DebuggerHidden]
		get
		{
	...
	internal static WebCheck.My.MyApplication Application
	{
		[DebuggerHidden]
		get
		{
