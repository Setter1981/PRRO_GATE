...
## 📍 WHERE WE ARE NOW: CS-0 (in progress)
Plan LOCKED (rev 5). Next concrete moves: PR the plan to main; author specs #1 (transition contract)
+ #2 (delivery/reservation FSM). Nothing coded yet.
