...
internal class SendingMail
{
	...
	public TypMail LoadEmail()
	{
		...
		if (Operators.CompareString(result.From.Trim(), "", TextCompare: false) == 0)
		{
		...
		if (Operators.CompareString(result.Pass.Trim(), "", TextCompare: false) == 0)
		{
			result.Pass = "0123";
		...
		if (Operators.CompareString(result.Host.Trim(), "", TextCompare: false) == 0)
		{
