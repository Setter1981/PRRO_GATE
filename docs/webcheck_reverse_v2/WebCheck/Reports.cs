...
internal class Reports
{
			...
			try
			{
				...
				while (sQLiteDataReader.Read())
				{
					...
					case 1:
						...
						if (Operators.CompareString(result.SMIM.Trim(), "", TextCompare: false) == 0)
						{
							result.SMIM = "0";
						}
						else
					...
					case 2:
						...
						if (Operators.CompareString(result.SMIP.Trim(), "", TextCompare: false) == 0)
						{
							result.SMIP = "0";
						}
						else
					...
					case 3:
						...
						if (Operators.CompareString(result.SMOM.Trim(), "", TextCompare: false) == 0)
						{
							result.SMOM = "0";
						}
						else
					...
					case 4:
						...
						if (Operators.CompareString(result.SMOP.Trim(), "", TextCompare: false) == 0)
						{
							result.SMOP = "0";
						}
						else
	...
	public TypPrintChecks CheckXMLNumberTax(string TaxNumberCheck)
	{
		...
		if (Operators.CompareString(TaxNumberCheck.Trim(), "", TextCompare: false) == 0)
		{
	...
	public TypPrintChecks CheckXMLNumber(string NumberCheck, bool SearchID = false)
	{
		...
		typPrintChecks.ReturnDocType = "";
		TypPrintChecks result;
		if (Operators.CompareString(NumberCheck.Trim(), "", TextCompare: false) == 0)
		{
