...
/// UNTOUCHED. No supersession (0 removals — additions-only). Bumped again to `041628a6` to cover the
/// `tests/invariant_scan.rs` WRAPPERS allowlist edit (register `sync_held_reservation`).
pub const LIVE_DRIFT_BASE_SHA: &str = "041628a6";
